    ...
    <div class="container-xxl d-flex align-items-stretch justify-content-between mw-100">
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a href="{{ route('dashboard') }}">
                <img src="https://pemadam.jakarta.go.id/central_assets/logo/logo-bundle.jpg" class="h-30px h-lg-40px" alt="{{ config('app.name', 'Logo') }}" />
            </a>
        </div>
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <a href="javascript:void(0)"
                                            class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::user()->penugasan->name ?? "" }}</a>
                                    </div>
                                </div>
                            </div>
