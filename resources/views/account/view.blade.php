<x-app-layout>
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-200px symbol-fixed position-relative">
                        <img src="{{ $row->photo_casual }}" alt="Profile Picture" />
                    </div>
                </div>
                <div class="d-flex flex-column">
                    <div class="d-flex align-items-center mb-2">
                        <a href="javascript:void(0)"
                            class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $row->nama }}</a>
                    </div>
                    <div class="d-flex flex-column fw-bold fs-6 mb-4 pe-2">
                        <a href="javascript:void(0)"
                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            <i class="fa fa-briefcase me-2"></i>{{ $row->jabatan }}
                        </a>
                        <a href="javascript:void(0)"
                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            <i class="fa fa-user-alt me-2"></i>{{ $row->penugasan }}
                        </a>
                        <a href="javascript:void(0)"
                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            <i class="fa fa-building me-2"></i>{{ $row->penempatan }}
                        </a>
                        <a href="javascript:void(0)"
                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            <i class="fa fa-envelope me-2"></i>{{ $row->email }}
                        </a>
                        <a href="javascript:void(0)"
                            class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            <i class="fa fa-mobile me-3"></i>{{ $row->no_telepon }}
                        </a>
                        <a href="javascript:void(0)" class="btn btn-primary w-auto me-5 mb-2" onclick="openForm('account/password-form')">
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body p-9">
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">NIP/NIK</label>
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">{{ $row->nip }}</span>
                </div>
            </div>
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">NRK/ID PJLP</label>
                <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">{{ $row->nrk }}</span>
                </div>
            </div>
            <div class="row mb-7">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 fv-row">
                    <span class="fw-bold text-gray-800 fs-6">{{ $row->tempat_lahir }},
                        {{ $row->tanggal_lahir }}</span>
                </div>
            </div>
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Jenis Kelamin</label>
